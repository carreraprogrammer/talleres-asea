      ...
      <div className="servicesAbstractListContainer">
        <ul className="servicesAbstractList">
          <li className="servicesAbstractListItem">
            ...
            <p>Fabricación de maquinaria para la construcción (mezcladoras, plumas grúas, cortadoras de concreto, reglas vibratorias, entre otros).</p>
          </li>
          <li className="servicesAbstractListItem">
            <BsCheck className="checkIcon" />
          ...
          <li className="servicesAbstractListItem">
            <BsCheck className="checkIcon" />
            <p>Construcción y reconstrucción de partes y piezas para maquinaria agrícola, industrial y de la construcción.</p>
          </li>
          <li className="servicesAbstractListItem">
            <BsCheck className="checkIcon" />
